 ...
 *
 * $Id: noise.cpp,v 1.1 2002-12-18 18:36:43 pepe Exp $
 *
...
static int   R(Vector *v);
static int   Crc16(register char *buf, register int  count);
 ...
 */
void
DNoise3(Vector *point,Vector* result)
{
	register int	ix, iy, iz, jx, jy, jz;
	Float		x, y, z;
	Float px, py, pz, s;
