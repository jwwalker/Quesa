 ...
 *
 * $Id: rotate.cpp,v 1.1 2002-12-18 18:36:41 pepe Exp $
 *
...
void        RotationMatrix(Float x,Float  y,Float z,Float theta,RSMatrix* trans);
 ...
 */
void
RotatePropagate(TransRef tr, RSMatrix *trans,RSMatrix* itrans)
{
 ...
 */
void
RotationMatrix(Float x,Float  y,Float z,Float theta,RSMatrix* trans)
{
