 ...
 *
 * $Id: vector.h,v 1.1 2002-12-18 18:36:42 pepe Exp $
 *
...
extern void     VecCross(
                    ...
                    Vector          *b,
                    Vector          *r);
extern void     VecCoordSys(
                    Vector              *vector,
                    Vector              *uaxis,
                    Vector              *vaxis);
extern Float	VecNormalize(
                    register Vector     *a);
extern Float    VecNormCross(
                    Vector              *a, 
                    Vector              *b, 
                    Vector              *r);
extern int Refract(Vector *dir, Float from_index,Float to_index,Vector* I,Vector* N,Float cos1);
