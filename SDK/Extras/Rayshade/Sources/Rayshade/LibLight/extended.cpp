 ...
 *
 * $Id: extended.cpp,v 1.1 2002-12-18 18:36:42 pepe Exp $
 *
...
Extended *
ExtendedCreate(Float r, Vector *pos)
{
	Extended *e;
...
static void
ExtendedMethodRegister(UserMethodType meth)
{
	if (iExtendedMethods)
