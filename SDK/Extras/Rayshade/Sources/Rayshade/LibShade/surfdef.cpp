 ...
 *
 * $Id: surfdef.cpp,v 1.1 2002-12-18 18:36:43 pepe Exp $
 *
...
SurfaceAddToDefined(Surface *surf)
{
	...
	if ((surf->name != (char *)NULL) && (SurfaceFetchNamed(surf->name) != (Surface *)NULL))
		RLerror(RL_WARN,
 ...
 */ 
void
SurfaceDeleteDefinedSurfaces(void)
{
    SurfaceDeleteEvery(Surfaces);
    Surfaces = NULL;
}
 ...
 */
Surface *
GetShadingSurf(HitList *hitlist)
{
	int i;
