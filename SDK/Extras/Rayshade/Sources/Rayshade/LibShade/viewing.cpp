 ...
 *
 * $Id: viewing.cpp,v 1.1 2002-12-18 18:36:43 pepe Exp $
 *
...
void  SampleScreenFiltered();
extern void SampleScreen(Float x, Float y,Ray *ray,Pixel *color, int sample);
...
static void
SampleScreenFiltered(Float x,Float y,int u,int v,Ray* ray,Pixel* color,int sample)
{
...
SampleScreen(
    Float   x, 
    Float   y,          /* Screen position to sample */
