...
#        $contentString .= "<thead><tr><th>Name</th><th>Description</th></tr></thead>\n";
        $contentString .= "<table bgcolor=\"#F0F0FF\" border=0 cellspacing=0 width = \"90%\">\n";
...
#                $contentString .= "<tr><td><tt>$fName</tt></td><td>$fDesc</td><tr>\n";
                $contentString .= "<tr valign=top><td><tt>$fName</tt></td><td>$fDesc</td><tr>\n";
...
#                $contentString .= "<tr><td><tt>$fName</tt></td><td>$fDesc<br>$paramString</td><tr>\n";
                $contentString .= "<tr valign=top><td><tt>$fName</tt></td><td>$fDesc<br>$paramString</td><tr>\n";
            } else {
