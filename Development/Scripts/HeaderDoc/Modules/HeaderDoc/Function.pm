...
# dair, preserve whitespace in Quesa headers
...
# dair, preserve asterisk location in Quesa headers
#        if ($paramName =~ /^\*/) {
#            $paramName =~ s/^(\*+)(\w+)/$2/;
#            $type .= " $1";
#        }
        
# dair, preserve 'void' in Quesa headers
...
#                $paramContentString .= "<tr><td align = \"center\"><tt>$pName</tt></td><td>$pDesc</td><tr>\n";
                $paramContentString .= "<tr valign=top><td><tt>$pName</tt></td><td>$pDesc</td></tr>\n";
            }
        }
...
#            $contentString .= "<thead><tr><th>Name</th><th>Description</th></tr></thead>\n";
            $contentString .= "<table bgcolor=\"#F0F0FF\" border=1 bordercolor=white cellpadding=0 cellspacing=0 width = \"90%\">\n";
            $contentString .= "<thead><tr valign=top bgcolor=\"#C8C8FF\"><th align=left>Name</th><th align=left>Description</th></tr></thead>\n";
