...
# Last Updated: $Date: 2001-03-18 13:25:59 $
# 
...
#		print OUTFILE "<HTML><HEAD><TITLE>Draft Inside Macintosh Reference</TITLE></HEAD>\n<BODY bgcolor=\"#ffffff\">\n";
		print OUTFILE "<HTML><HEAD><TITLE>Documentation for $headerName</TITLE></HEAD>\n<BODY background=\"../../../images/logo_gray.gif\" bgcolor=\"#ffffff\">\n";
...
#	    print OUTFILE "<p>&#169; $copyrightOwner &#151; (Last Updated $dateStamp)</p>\n";
	    print OUTFILE "<p align=center><font size=\"-1\"><a href=\"http://www.quesa.org/\">Copyright &#169; $copyrightOwner &#151; last updated on $dateStamp </a></font></p>\n";
		print OUTFILE "</BODY>\n</HTML>\n";
    } else {
...
sub _createHTMLOutputFile {
	...
	# dair, locate the correct path to the background image
	my $backgroundPath = "../../../images/logo_gray.gif";
	$backgroundPath    = "../$backgroundPath" if ($heading !~ /\w+\.h/);
	
# dair, updated style for Quesa
#	print OUTFILE "<html><head><title>$heading</title></head><body bgcolor=\"#ffffff\"><font face=\"Geneva,Arial,Helvtica\"><h1>$heading</h1></font><hr><br>\n";
	print OUTFILE "<html><head><title>$heading</title></head><body background=\"$backgroundPath\" bgcolor=\"#ffffff\"><font face=\"Geneva,Arial,Helvtica\"><h1>$heading</h1></font><hr><br>\n";
	print OUTFILE $fileString;
# dair, updated style for Quesa
#    print OUTFILE "<p>&#169; $copyrightOwner &#151; (Last Updated $dateStamp)</p>\n";
    print OUTFILE "<p align=center><font size=\"-1\"><a href=\"http://www.quesa.org/\">Copyright &#169; $copyrightOwner &#151; last updated on $dateStamp </a></font></p>\n";
