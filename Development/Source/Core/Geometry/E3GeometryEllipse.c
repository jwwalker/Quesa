...
//-----------------------------------------------------------------------------
static TQ3Status
e3geom_ellipse_bounds(TQ3ViewObject theView, TQ3ObjectType objectType, TQ3Object theObject, const void *objectData)
{	const TQ3EllipseData	*instanceData = (const TQ3EllipseData *) objectData;
...
{	TQ3XFunctionPointer		theMethod = NULL;
	...
	switch (methodType) {
		...
		case kQ3XMethodTypeObjectSubmitBounds:
			theMethod = (TQ3XFunctionPointer) e3geom_ellipse_bounds;
			break;
