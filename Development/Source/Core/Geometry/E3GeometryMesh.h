...
*/
#ifndef __E3GEOMETRY_MESH__
#define __E3GEOMETRY_MESH__
//=============================================================================
//      Include files
//-----------------------------------------------------------------------------
...
TQ3MeshFace			E3Mesh_FaceNew(TQ3GeometryObject theMesh, unsigned long numVertices, const TQ3MeshVertex *vertices, TQ3AttributeSet attributeSet);
...
TQ3Status			E3Mesh_GetNumComponents(TQ3GeometryObject theMesh, unsigned long *numComponents);
TQ3Status			E3Mesh_GetNumEdges(TQ3GeometryObject theMesh, unsigned long *numEdges);
TQ3Status			E3Mesh_GetNumVertices(TQ3GeometryObject theMesh, unsigned long *numVertices);
TQ3Status			E3Mesh_GetNumFaces(TQ3GeometryObject theMesh, unsigned long *numFaces);
TQ3Status			E3Mesh_GetNumCorners(TQ3GeometryObject theMesh, unsigned long *numCorners);
TQ3Status			E3Mesh_GetOrientable(TQ3GeometryObject theMesh, TQ3Boolean *orientable);
TQ3Status			E3Mesh_GetComponentNumVertices(TQ3GeometryObject theMesh, TQ3MeshComponent component, unsigned long *numVertices);
TQ3Status			E3Mesh_GetComponentNumEdges(TQ3GeometryObject theMesh, TQ3MeshComponent component, unsigned long *numEdges);
...
TQ3Status			E3Mesh_GetVertexIndex(TQ3GeometryObject theMesh, TQ3MeshVertex vertex, unsigned long *index);
...
TQ3Status			E3Mesh_GetFaceNumVertices(TQ3GeometryObject theMesh, TQ3MeshFace face, unsigned long *numVertices);
TQ3Status			E3Mesh_GetFacePlaneEquation(TQ3GeometryObject theMesh, TQ3MeshFace face, TQ3PlaneEquation *planeEquation);
TQ3Status			E3Mesh_GetFaceNumContours(TQ3GeometryObject theMesh, TQ3MeshFace face, unsigned long *numContours);
TQ3Status			E3Mesh_GetFaceIndex(TQ3GeometryObject theMesh, TQ3MeshFace face, unsigned long *index);
...
TQ3Status			E3Mesh_GetContourNumVertices(TQ3GeometryObject theMesh, TQ3MeshContour contour, unsigned long *numVertices);
